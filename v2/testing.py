...
def apts(tmp_path: pathlib.Path) -> ApartmentDatabase:
    ...
    rows = [
        ...
        Apartment(
            number=420,
            tenants=["alex", "ben", "catherine"],
            visitors=["daniel", "elise", "francis"],
        ),
        Apartment(
            number=101, tenants=["Tanya"], visitors=["John Watson", "Mary Watson"]
        ),
        Apartment(number=102, tenants=["Mike Bowen"], visitors=["Tom"]),
        Apartment(number=103, tenants=["Gail Lee"], visitors=[]),
        Apartment(number=104, tenants=[], visitors=[]),
        Apartment(number=105, tenants=[], visitors=[]),
        Apartment(
            number=201, tenants=["john", "mary"], visitors=["Jerry", "Eric Wang", "Tom"]
        ),
        Apartment(number=202, tenants=[], visitors=[]),
        Apartment(number=203, tenants=[], visitors=[]),
        Apartment(number=204, tenants=[], visitors=[]),
        Apartment(number=205, tenants=[], visitors=["Barack Obama"]),
        Apartment(number=301, tenants=[], visitors=[]),
        Apartment(number=302, tenants=[], visitors=[]),
        Apartment(number=303, tenants=[], visitors=[]),
        Apartment(number=304, tenants=[], visitors=[]),
        Apartment(number=305, tenants=[], visitors=[]),
    ]
...
def test_get_apt(apts: ApartmentDatabase):
    assert apts.get_apt(69) == Success(
        Apartment(
            number=69,
            tenants=["alice", "bob", "cindy"],
            visitors=["david", "ethan", "frank", "bruh"],
