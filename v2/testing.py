...
def test_get_numbers(apts: ApartmentDatabase):
    assert apts.get_numbers() == [69, 420, 101, 102, 103, 104,
                                  105, 201, 202, 203, 204, 205, 301, 302, 303, 304, 305]
